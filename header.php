...
//Poveži se z bazo
$conn = new mysqli('localhost', 'root', '', 'vaja2'); //conn globalna spr.
                  ...
                  <li class="nav-item"><a class="nav-link" href="myad.php">Moji oglasi</a></li>
                    ...
                    if($_SESSION["administrator"] == 1){ ?>
                      <li class="nav-item"><a class="nav-link" href="admin/index.php">Administracija</a></li>
                        <li class="nav-item"><a class="nav-link" href="admin/index.php?controller=pages&action=api">Uporaba API</a></li>
                        <?php
                    }
                        ?>
